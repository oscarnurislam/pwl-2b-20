            ...
            <section class="tm-welcome">
                ...
                <div class="row tm-welcome-row">
                    ...
                    <article class="col-lg-6 tm-media">
                        ...
                        <a class="tm-btn tm-btn-rounded tm-article-link" href="http://localhost:8000/products">Daftar Produk Kami</a>
                </div>
                ...
                <div class="row tm-welcome-row-2">
                    <div class="col-lg-4 tm-dotted-box-container">
                        <article class="tm-dotted-box">
                            ...
                            <a class="tm-btn tm-btn-rounded tm-article-link" href="templateusage">More Details</a>
                        </article>    
                    </div>
                    <div class="col-lg-4 tm-dotted-box-container">
                        <article class="tm-dotted-box">
                            ...
                            <a class="tm-btn tm-btn-rounded tm-article-link" href="newvision">More Details</a>
                        </article>    
                    </div>
                    <div class="col-lg-4 tm-dotted-box-container">
                        <article class="tm-dotted-box">
                            ...
                            <a class="tm-btn tm-article-link" href="downloadsites">Read More...</a>
                        </article>
                    </div>
                </div>
            </section>
